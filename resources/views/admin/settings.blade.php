...
<div class="row">
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago FreeKassa</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>FK ID</label>
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(2)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago Piastrix</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(3)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago Primepayments</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(4)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago Linepay</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>ID del proyecto</label>
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(5)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago Paypaylych</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>ID del proyecto</label>
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(6)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Configuracion del sistema de pago AezaPay</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>ID del proyecto</label>
					...
					<div class="col-lg">
						<label>Accion</label>
						<button onclick="saveSetting(7)" class="btn btn-info btn-block w-100">Guardar</button>
					</div>
